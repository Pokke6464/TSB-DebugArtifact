...
# 直立：難易度を変更する
    execute unless predicate lib:is_sneaking if entity @s[x_rotation=-80..80] run function asset:artifact/8801.debug_artifact_beta/use/change_difficulty
...
# 直立+上向き：信仰を変更する
    execute unless predicate lib:is_sneaking unless entity @s[x_rotation=-80..90] run function asset:artifact/8801.debug_artifact_beta/use/change_believe

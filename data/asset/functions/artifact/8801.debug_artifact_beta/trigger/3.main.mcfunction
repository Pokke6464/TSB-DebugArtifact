#> asset:artifact/8801.debug_artifact_beta/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/8801.debug_artifact_beta/trigger/2.check_condition
...
# スニーク+下向き：半径50m内の全ての敵に9999.9ダメージ
    execute if predicate lib:is_sneaking unless entity @s[x_rotation=-90..80] run function asset:artifact/8801.debug_artifact_beta/trigger/attack

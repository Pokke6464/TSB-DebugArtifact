#> asset:artifact/8800.debug_artifact_alpha/trigger/change_believe
#
# 神器のメイン処理部
#
...
# 変更後の信仰を表示
    execute if entity @s[tag=Believe.None] run tellraw @s [{"text":"信仰する神を ","color":"white"},{"text":"\uE000","font":"icon"},{"text":"フローラ","color":"white","bold":true},{"text":" に変更しました。","color":"white"}]
    execute if entity @s[tag=Believe.Flora] run tellraw @s [{"text":"信仰する神を ","color":"white"},{"text":"\uE001","font":"icon"},{"text":"ウルバン","color":"white","bold":true},{"text":" に変更しました。","color":"white"}]
    execute if entity @s[tag=Believe.Urban] run tellraw @s [{"text":"信仰する神を ","color":"white"},{"text":"\uE002","font":"icon"},{"text":"ニャプトフ","color":"white","bold":true},{"text":" に変更しました。","color":"white"}]
    execute if entity @s[tag=Believe.Nyaptov] run tellraw @s [{"text":"信仰する神を ","color":"white"},{"text":"\uE003","font":"icon"},{"text":"ウィ＝キ","color":"white","bold":true},{"text":" に変更しました。","color":"white"}]
    execute if entity @s[tag=Believe.Wi-ki] run tellraw @s [{"text":"信仰する神を ","color":"white"},{"text":"\uE004","font":"icon"},{"text":"ルーモア","color":"white","bold":true},{"text":" に変更しました。","color":"white"}]
    execute if entity @s[tag=Believe.Rumor] run tellraw @s [{"text":"信仰する神を ","color":"white"},{"text":"無信仰","color":"white","bold":true},{"text":" に変更しました。","color":"white"}]
